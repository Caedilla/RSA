...
L["Only announce if you are in combat."] = "Объявлять в чат только, если вы в бою."
L["Only announce in /emote while you are in a group."] = [=[Объявлять только в /эмоцию,
пока вы находитесь в группе.]=]
L["Only announce in /say while you are in a group."] = [=[Объявлять только в /сказать,
пока вы находитесь в группе.]=]
L["Only announce in /yell while you are in a group."] = [=[Объявлять только в /крикнуть,
пока вы находитесь в группе.]=]
--[[Translation missing --]]
...
L["When you cast this spell."] = "Когда вы произносите это заклинание."
L["When you deal damage."] = "Когда вы наносите урон."
--[[Translation missing --]]
...
L["When you interrupt a spell cast."] = "Когда вы прерываете произносимое заклинание."
--[[Translation missing --]]
