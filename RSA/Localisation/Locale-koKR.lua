...
L["If selected, |c5500DBBD[MISSTYPE]|r will always use the General Replacement set below."] = "이 옵션을 선택하면 |c5500DBBD[MISSTYPE]|r은 항상 아래의 일반 대체 세트를 사용합니다."
L["If selected, |c5500DBBD[TARGET]|r will always use the spell target's name, rather than using the input below for whispers."] = "이 옵션을 선택하면 |c5500DBBD[TARGET]|r은 귀속말을 위해 아래 입력을 사용하지 않고 항상 대상의 이름을 사용합니다."
...
L["When the target absorbs your spell |c5500DBBD[MISSTYPE]|r will be replaced with this."] = "대상이 주문을 흡수하면 |c5500DBBD[MISSTYPE]|r (으)로 대체됩니다."
L["When the target blocks your spell |c5500DBBD[MISSTYPE]|r will be replaced with this."] = "대상이 주문을 막으면 |c5500DBBD[MISSTYPE]|r (으)로 대체됩니다."
L["When the target deflects your spell |c5500DBBD[MISSTYPE]|r will be replaced with this."] = "대상이 주문을 빗나가면 |c5500DBBD[MISSTYPE]|r (으)로 대체됩니다."
L["When the target dodges your spell |c5500DBBD[MISSTYPE]|r will be replaced with this."] = "대상이 주문을 회피하면 |c5500DBBD[MISSTYPE]|r (으)로 대체됩니다."
L["When the target evades your spell |c5500DBBD[MISSTYPE]|r will be replaced with this."] = "대상이 주문을 피하면 |c5500DBBD[MISSTYPE]|r (으)로 대체됩니다."
L["When the target is immune to your spell |c5500DBBD[MISSTYPE]|r will be replaced with this."] = "대상이 주문에 면역이되어있을 때 |c5500DBBD[MISSTYPE]|r (으)로 대체됩니다."
L["When the target is immune to your spell."] = "대상이 주문에 면역인 경우입니다."
L["When the target parries your spell |c5500DBBD[MISSTYPE]|r will be replaced with this."] = "대상이 주문을 무막하면 |c5500DBBD[MISSTYPE]|r (으)로 바뀝니다."
--[[Translation missing --]]
...
L["When the target resists your spell |c5500DBBD[MISSTYPE]|r will be replaced with this."] = "타겟이 주문에 저항하면 |c5500DBBD[MISSTYPE]|r(으)로 대체됩니다."
